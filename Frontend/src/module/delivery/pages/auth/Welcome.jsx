        ...
        >
          ...
          <div className="flex justify-center mb-4">
            <div className="relative">
              <div className="w-24 h-24 bg-red-600 rounded-lg flex items-center justify-center relative overflow-visible">
                <div className="absolute inset-0 bg-gradient-to-br from-red-500 to-red-700 rounded-lg"></div>
                ...
                <div className="relative z-10">
                  ...
                  {/* Note 1 - Back (left) */}
                  <div className="w-10 h-14 bg-red-400 rounded-sm transform -rotate-12 absolute -left-2 top-1/2 -translate-y-1/2 z-0 shadow-md"></div>
                  
                  {/* Note 2 - Middle */}
                  <div className="w-10 h-14 bg-red-300 rounded-sm transform rotate-0 relative z-10 shadow-lg"></div>
                  
                  {/* Note 3 - Front (right) */}
                  <div className="w-10 h-14 bg-red-200 rounded-sm transform rotate-12 absolute -right-2 top-1/2 -translate-y-1/2 z-20 shadow-xl flex items-center justify-center">
      ...
      >
        <div className="flex flex-col items-center py-6 relative overflow-hidden">
            ...
            {[...Array(30)].map((_, i) => (
              <motion.div
                ...
                style={{
                  ...
                  top: `-5%`,
                  backgroundColor: ['#8B2E2E', '#3b82f6', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899'][Math.floor(Math.random() * 6)],
                }}
                initial={{
                  y: -50,
                  opacity: 1,
          ...
          <div className="relative mb-6 z-10">
            ...
            <motion.div
              className="w-32 h-32 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-2xl relative overflow-hidden"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{
                type: "spring",
