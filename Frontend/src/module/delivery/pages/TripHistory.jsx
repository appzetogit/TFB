        ...
        <div className="flex gap-6">
          ...
          >
            <span className={`text-base font-medium transition-colors ${
              activeTab === "daily" ? "text-red-600" : "text-gray-500"
            }`}>
              Daily
            </span>
            {activeTab === "daily" && (
              <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-red-600 mt-2"></div>
            )}
          </button>
          <button
            onClick={() => {
          ...
          >
            <span className={`text-base font-medium transition-colors ${
              activeTab === "monthly" ? "text-red-600" : "text-gray-500"
            }`}>
              Monthly
            </span>
            {activeTab === "monthly" && (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                    ...
                    {(() => {
                      ...
                      return (
                        <span className={`inline-block mt-2 text-xs font-medium px-2 py-1 rounded-full ${
                          isCOD ? 'bg-amber-100 text-amber-700' : 'bg-red-100 text-red-700'
                        }`}>
                          {isCOD ? 'COD' : 'Online'}
                        </span>
                      );
                  ...
                  <span className={`text-sm font-medium ${
                    trip.status === 'Completed' ? 'text-red-600' :
