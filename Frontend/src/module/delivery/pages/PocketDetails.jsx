...
export default function PocketDetails() {
  ...
  const getPaymentMethod = (order) => {
    ...
    if (!paymentMethod) {
      ...
      return { type: 'Online', label: 'Online', color: 'text-red-600' }
    }
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-red-600 font-semibold">+{formatCurrency(summary.totalBonus)}</span>
            </div>
                  ...
                  <div className="pt-3 border-t border-gray-100 space-y-2">
                    ...
                    {bonus > 0 && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-red-600 font-semibold">+{formatCurrency(bonus)}</span>
                      </div>
                    )}
