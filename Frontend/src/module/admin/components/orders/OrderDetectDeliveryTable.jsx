...
const getStatusColor = (status) => {
  const colors = {
    ...
    "Ordered Delivered": "bg-red-100 text-red-700",
  }
                    ...
                    <div className="flex items-center justify-center gap-2 flex-wrap">
                      {order.originalOrder && ['preparing', 'confirmed'].includes(order.originalOrder.status) && !order.originalOrder.tracking?.ready?.status && onMarkReady && (
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2 py-1.5 rounded text-xs font-medium bg-red-600 text-white hover:bg-red-700 disabled:opacity-60 transition-colors"
