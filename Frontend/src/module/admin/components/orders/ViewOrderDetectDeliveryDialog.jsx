...
const getStatusColor = (status) => {
  const colors = {
    ...
    "Restaurant Accepted": "bg-red-100 text-red-700 border-red-200",
    "Accepted": "bg-red-100 text-red-700 border-red-200", // Keep for backward compatibility
    ...
    "Ordered Delivered": "bg-red-100 text-red-700 border-red-200",
  }
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-200 bg-slate-50">
          {canMarkReady && (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg bg-red-600 text-white hover:bg-red-700 disabled:opacity-60 transition-all"
            >
