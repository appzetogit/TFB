          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-3xl font-bold text-red-600">{restaurantVATStats.totalOrderAmount}</p>
                <p className="text-lg font-semibold text-red-600 mt-1">{restaurantVATStats.totalOrderAmount}</p>
              </div>
