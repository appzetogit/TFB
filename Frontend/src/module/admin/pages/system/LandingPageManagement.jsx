                    ...
                    <div key={banner._id} className="border border-slate-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                      <div className="relative aspect-video bg-slate-100">
                        ...
                        <div className="absolute top-2 right-2">
                          <span className={`px-2 py-1 rounded text-xs font-medium ${banner.isActive ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}`}>
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between gap-2 flex-wrap">
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <button onClick={() => handleToggleBannerStatus(banner._id, banner.isActive)} className={`px-3 py-1.5 rounded text-sm font-medium ${banner.isActive ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                    ...
                    <div key={banner._id} className="border border-slate-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button onClick={() => handleToggleUnder250BannerStatus(banner._id, banner.isActive)} className={`px-3 py-1.5 rounded text-sm font-medium ${banner.isActive ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                            {banner.isActive ? 'Deactivate' : 'Activate'}
                          </button>
                    ...
                    <div key={banner._id} className="border border-slate-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                      ...
                      <div className="p-4 bg-white">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button onClick={() => handleToggleDiningBannerStatus(banner._id, banner.isActive)} className={`px-3 py-1.5 rounded text-sm font-medium ${banner.isActive ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                            {banner.isActive ? 'Deactivate' : 'Activate'}
                          </button>
                        ...
                        .map((item, index) => (
                          <div key={item._id} className="border border-slate-200 rounded-lg p-4 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button onClick={() => handleToggleTop10Status(item._id, item.isActive)} className={`px-3 py-1.5 rounded text-sm font-medium ${item.isActive ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                            ...
                            <div key={item._id} className="border border-slate-200 rounded-lg overflow-hidden">
                              <div className="relative h-32 bg-slate-100">
                                ...
                                <div className="absolute top-1 right-1">
                                  <span className={`px-1.5 py-0.5 rounded text-[10px] font-medium ${item.isActive ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}`}>
                              ...
                              <div className="p-2">
                                ...
                                <div className="flex items-center justify-between gap-1">
                                  ...
                                  <button onClick={() => handleToggleGourmetStatus(item._id, item.isActive)} className={`px-2 py-1 rounded text-[10px] font-medium ${item.isActive ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'}`}>
                                    {item.isActive ? 'Deactivate' : 'Activate'}
                                  </button>
