...
export default function DeliveryWithdrawal() {
  ...
  const getStatusBadge = (status) => {
    if (status === "Approved" || status === "Processed") return "bg-red-100 text-red-700"
          ...
          <DialogContent className="max-w-md bg-white p-0">
            ...
            <DialogFooter className="px-6 pb-6">
              <button
                ...
                className="px-4 py-2 text-sm font-medium rounded-lg bg-red-600 text-white hover:bg-red-700 transition-all"
              >
                Close
              </button>
            </DialogFooter>
