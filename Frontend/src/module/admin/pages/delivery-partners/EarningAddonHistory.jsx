...
export default function EarningAddonHistory() {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      ...
      credited: { bg: "bg-red-100", text: "text-red-700", label: "Credited", icon: CheckCircle },
    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <Dialog open={isCreditDialogOpen} onOpenChange={setIsCreditDialogOpen}>
        <DialogContent className="max-w-lg bg-gradient-to-br from-white via-slate-50 to-white p-0 border-0 shadow-2xl">
          ...
          <div className="bg-gradient-to-r from-red-500 to-red-600 px-6 py-5 rounded-t-lg">
          ...
          {selectedHistory && (
            <div className="px-6 py-6 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-red-50 to-red-50 rounded-xl border-2 border-red-200">
                  <div className="p-2 bg-red-100 rounded-lg">
                    <DollarSign className="w-5 h-5 text-red-600" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs font-medium text-red-700 uppercase tracking-wide mb-1">Amount to Credit</p>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all resize-none text-sm text-slate-700 placeholder:text-slate-400"
                  rows={4}
              ...
              <DialogFooter className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                ...
                <button
                  ...
                  className="px-5 py-2.5 text-sm font-semibold rounded-xl bg-gradient-to-r from-red-500 to-red-600 text-white hover:from-red-600 hover:to-red-700 shadow-lg shadow-red-500/30 transition-all flex items-center gap-2"
                >
