                  ...
                  filteredData.map((order, index) => (
                    <tr key={order.orderId} className="hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        ...
                        <div className="text-xs text-red-600 mt-0.5">{order.paymentStatus}</div>
                      </td>
                      <td className="px-6 py-4">
                        ...
                        <div className="flex items-center justify-center gap-2">
                          ...
                          {order.refundStatus !== 'processed' && (
                            <button 
                              ...
                              className="p-1.5 rounded bg-red-600 text-white hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1"
