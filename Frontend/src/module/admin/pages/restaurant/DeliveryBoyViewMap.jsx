          ...
          <div style="padding: 12px; min-width: 200px;">
            ...
            <div style="font-size: 13px; color: #64748b; line-height: 1.6;">
              ...
              <div>
                ...
                <span style="color: ${zone.isActive ? '#671E1F' : '#ef4444'}; font-weight: 600;">
        ...
        content: `
          <div style="padding: 12px; min-width: 200px;">
            ...
            <div style="font-size: 13px; color: #64748b; line-height: 1.6;">
              ...
              <div style="margin-bottom: 4px;">
                <strong>Status:</strong> 
                <span style="color: #671E1F; font-weight: 600;">Online</span>
              </div>
              ${lastUpdate ? `
            ...
            <div className="mt-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
              ...
              <div className="text-xs text-slate-600 space-y-1">
                ...
                {deliveryBoys.length > 0 && (
                  <p>
                    Click on any <span className="font-semibold text-red-600">green bike icon</span> to view delivery boy details. Online delivery boys: <strong>{deliveryBoys.length}</strong>
                  </p>
                )}
                {deliveryBoys.length === 0 && (
