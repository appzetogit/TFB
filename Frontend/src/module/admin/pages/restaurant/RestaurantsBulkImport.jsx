      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
        <div className="flex items-start gap-6">
          ...
          <div className="p-6 bg-red-50 rounded-lg">
            <FileSpreadsheet className="w-16 h-16 text-red-600" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            ...
            <label
              htmlFor="file-upload"
              className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-slate-300 rounded-lg bg-slate-50 cursor-pointer hover:bg-slate-100 hover:border-red-500 transition-all"
            >
              {selectedFile ? (
                ...
                <div className="flex flex-col items-center gap-3">
                  <div className="p-4 bg-red-50 rounded-lg">
                    <FileSpreadsheet className="w-12 h-12 text-red-600" />
                  </div>
