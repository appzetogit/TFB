                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 flex-wrap">
                        ...
                        <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                          restaurantDetails?.isActive !== false ? "bg-red-100 text-red-700" : "bg-blue-100 text-blue-700"
                        }`}>
                        ...
                        {restaurantDetails?.featuredDish && (
                          <div>
                            ...
                            {restaurantDetails.featuredPrice && (
                              <p className="text-xs text-red-600 mt-1">₹{restaurantDetails.featuredPrice}</p>
                            )}
                          </div>
                        )}
                      </div>
