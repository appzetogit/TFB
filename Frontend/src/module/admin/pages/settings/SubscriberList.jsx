...
const statsCards = [
  ...
  { id: 2, label: "Active Subscriptions", value: 0, bg: "bg-red-50" },
    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 mb-4">
        <div className="flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-slate-200">
          ...
          <div className="flex-1 px-5 py-3 flex items-center justify-between text-xs">
            <div className="flex items-center gap-2 text-slate-700">
              <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-red-50 text-red-600 text-lg">
                💰
              </span>
              <div>
...
function StatusPill({ label, variant }) {
  ...
  return (
    <span className="inline-flex items-center px-3 py-1 rounded-full bg-red-50 text-red-600 text-[11px] font-semibold">
      {label}
    </span>
  );
}
