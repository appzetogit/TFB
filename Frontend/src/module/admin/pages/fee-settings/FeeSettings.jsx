                        ...
                        {feeSettings.deliveryFeeRanges
                          ...
                          .map(({ range, originalIndex }) => (
                            <tr key={originalIndex} className="hover:bg-slate-50">
                              ...
                              <td className="px-4 py-3 text-sm font-medium text-red-600 border-b border-slate-100">₹{range.fee}</td>
                    ...
                    <div className="flex items-end gap-2">
                      {editingRangeIndex !== null ? (
                        ...
                        <Button
                          ...
                          className="bg-red-600 hover:bg-red-700 text-white text-sm flex-1 flex items-center justify-center gap-2"
                        >
