      ...
      <html>
        <head>
          ...
          <style>
            ...
            .invoice-header {
              border-bottom: 2px solid #671E1F;
              padding-bottom: 20px;
              margin-bottom: 30px;
            }
            .invoice-title {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <div className="flex gap-2 no-print">
              ...
              <Button
                ...
                className="bg-red-600 hover:bg-red-700 flex items-center gap-2 text-xs sm:text-sm h-9 sm:h-10"
              >
            ...
            <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
              ...
              <div className="invoice-header">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                  ...
                  <h2 className="invoice-title text-xl sm:text-2xl md:text-3xl text-red-600 font-bold">INVOICE</h2>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                  ...
                  <Badge className="bg-red-600 text-white text-sm sm:text-base md:text-lg px-3 sm:px-4 py-1.5 sm:py-2 w-fit">
              ...
              <div className="total-section mt-4 sm:mt-6">
                ...
                <div className="grand-total flex justify-between text-base sm:text-lg md:text-xl md:text-2xl pt-2 sm:pt-3 mt-2 sm:mt-3 border-t-2 border-red-600">
                  <span>Total:</span>
