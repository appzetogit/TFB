          ...
          <div className="mb-6">
            <div className="relative max-w-3xl mx-auto">
              <Input
                ...
                className="w-full h-12 sm:h-14 md:h-16 pl-12 sm:pl-14 pr-12 sm:pr-14 rounded-xl border-2 border-gray-200 focus:border-red-500 bg-white shadow-sm text-base sm:text-lg md:text-xl"
              />
