...
export default function DiningCategory() {
  ...
  return (
    <AnimatedPage className="min-h-screen bg-[#671E1F]">
                  ...
                  return (
                    <Button
                      ...
                      className={`h-8 sm:h-9 px-3 rounded-full flex items-center gap-1.5 whitespace-nowrap flex-shrink-0 transition-all font-medium shadow-sm border-0 ${isActive
                        ? 'bg-[#671E1F] text-white hover:bg-[#671E1F]/90'
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-1">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-lg font-bold text-gray-900 line-clamp-1 group-hover:text-[#671E1F] transition-colors">
                              {restaurant.name}
                            </h3>
                            <p className="text-sm text-gray-500 line-clamp-1 truncate">{restaurant.cuisine}</p>
                          </div>
                          <div className="flex-shrink-0 bg-[#671E1F] text-white px-2 py-0.5 rounded-md flex items-center gap-0.5 shadow-sm">
          ...
          <div className="absolute bottom-0 left-0 right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 md:bottom-auto md:top-1/2 md:-translate-y-1/2 bg-white rounded-t-3xl md:rounded-3xl max-h-[85vh] md:max-h-[90vh] md:max-w-lg w-full md:w-auto flex flex-col animate-[slideUp_0.3s_ease-out] shadow-2xl">
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
              ...
              <button
                ...
                className="text-[#671E1F] font-bold text-sm hover:bg-red-50 px-3 py-1 rounded-lg transition-colors"
              >
                Clear all
              </button>
            </div>
                ...
                {[
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1.5 py-4 px-2 text-center relative transition-all ${isActive ? 'bg-white text-[#671E1F] shadow-sm' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700'
                        }`}
                    >
                      {isActive && (
                        <div className="absolute left-0 top-3 bottom-3 w-1 bg-[#671E1F] rounded-r-full" />
                      )}
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`px-4 py-3.5 rounded-xl border text-left transition-all flex items-center justify-between group ${sortBy === option.id
                            ? 'border-[#671E1F] bg-[#671E1F]/5 shadow-sm'
                            : 'border-gray-200 hover:border-[#671E1F] hover:bg-gray-50'
                            }`}
                        >
                          <span className={`text-sm font-bold ${sortBy === option.id ? 'text-[#671E1F]' : 'text-gray-700'}`}>
                            {option.label}
                          </span>
                          {sortBy === option.id && <div className="h-2 w-2 rounded-full bg-[#671E1F]" />}
                        </button>
                      ))}
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <button
                        ...
                        className={`flex items-center gap-3 p-4 rounded-xl border transition-all ${activeFilters.has('delivery-under-30')
                          ? 'border-[#671E1F] bg-[#671E1F]/5'
                          : 'border-gray-200 hover:border-[#671E1F]'
                          }`}
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('delivery-under-30') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <Timer className="h-5 w-5" strokeWidth={2} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('delivery-under-30') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under 30 mins</span>
                      </button>
                      <button
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('delivery-under-45') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <Timer className="h-5 w-5" strokeWidth={2} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('delivery-under-45') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under 45 mins</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'rating' && (
                  <div className="space-y-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('rating-35-plus') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <Star className={`h-5 w-5 ${activeFilters.has('rating-35-plus') ? 'fill-[#671E1F]' : ''}`} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('rating-35-plus') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Rated 3.5+</span>
                      </button>
                      <button
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('rating-4-plus') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <Star className={`h-5 w-5 ${activeFilters.has('rating-4-plus') ? 'fill-[#671E1F]' : ''}`} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('rating-4-plus') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Rated 4.0+</span>
                      </button>
                      <button
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('rating-45-plus') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <Star className={`h-5 w-5 ${activeFilters.has('rating-45-plus') ? 'fill-[#671E1F]' : ''}`} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('rating-45-plus') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Rated 4.5+</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'distance' && (
                  <div className="space-y-4 mb-4">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('distance-under-1km') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <MapPin className="h-5 w-5" strokeWidth={2} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('distance-under-1km') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under 1 km</span>
                      </button>
                      <button
                      ...
                      >
                        <div className={`p-2 rounded-full ${activeFilters.has('distance-under-2km') ? 'bg-[#671E1F]/10 text-[#671E1F]' : 'bg-gray-100 text-gray-500'}`}>
                          <MapPin className="h-5 w-5" strokeWidth={2} />
                        </div>
                        <span className={`text-sm font-bold ${activeFilters.has('distance-under-2km') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under 2 km</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'price' && (
                  <div className="space-y-4 mb-4">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      >
                        <span className={`text-sm font-bold ${activeFilters.has('price-under-200') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under ₹200</span>
                      </button>
                      <button
                      ...
                      >
                        <span className={`text-sm font-bold ${activeFilters.has('price-under-500') ? 'text-[#671E1F]' : 'text-gray-700'}`}>Under ₹500</span>
                      </button>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4 mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['Continental', 'Italian', 'Asian', 'Indian', 'Chinese', 'American', 'Seafood', 'Cafe'].map((cuisine) => (
                        ...
                        >
                          <span className={`text-sm font-bold ${selectedCuisine === cuisine ? 'text-[#671E1F]' : 'text-gray-700'}`}>
                            {cuisine}
                          </span>
                        </button>
                      ))}
            ...
            <div className="flex items-center gap-4 px-6 py-5 border-t border-gray-100 bg-white rounded-b-3xl">
              ...
              <button
                onClick={() => setIsFilterOpen(false)}
                className={`flex-1 py-3.5 font-bold rounded-xl transition-all shadow-lg shadow-[#671E1F]/20 ${activeFilters.size > 0 || sortBy || selectedCuisine
                  ? 'bg-[#671E1F] text-white hover:bg-[#218a56] active:scale-[0.98]'
