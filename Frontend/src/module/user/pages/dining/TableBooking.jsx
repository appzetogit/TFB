    ...
    return (
        <AnimatedPage className="bg-slate-50 min-h-screen pb-24">
            ...
            <div className="bg-white px-4 pt-4 pb-12 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-[#671E1F]/5 rounded-full blur-3xl opacity-50 -mr-20 -mt-20"></div>
                <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#671E1F]/20 rounded-full blur-3xl opacity-30 -ml-16 -mb-16"></div>
            ...
            <div className="px-4 -mt-6 relative z-20 space-y-4">
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none bg-slate-50 border border-slate-200 rounded-lg py-2 pl-4 pr-10 font-bold text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#671E1F]"
                        >
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
                    <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                        <Calendar className="w-4 h-4 text-[#671E1F]" />
                        Select date
                    </h3>
                        ...
                        {dates.map((date, idx) => (
                            <button
                                ...
                                className={`min-w-[110px] p-3 rounded-2xl border transition-all flex flex-col items-center gap-1 ${selectedDate.toDateString() === date.toDateString()
                                    ? "bg-[#671E1F]/10 border-[#671E1F] shadow-[0_0_15px_rgba(43,156,100,0.1)]"
                                    : "bg-white border-slate-100 hover:border-slate-200"
                                    }`}
                            >
                                <span className={`text-xs font-bold uppercase tracking-wider ${selectedDate.toDateString() === date.toDateString() ? "text-[#671E1F]" : "text-gray-400"
                                    }`}>
                                    {formatDate(date)}
                                </span>
                ...
                <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 min-h-[400px]">
                    <h3 className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                        <Clock className="w-4 h-4 text-[#671E1F]" />
                        Select time of day
                    </h3>
                        ...
                        {["Lunch", "Dinner"].map(type => (
                            <button
                                ...
                                className={`flex-1 py-2.5 rounded-lg font-bold text-sm transition-all ${activeTimeOfDay === type
                                    ? "bg-[#671E1F] text-white shadow-sm"
                                    : "text-gray-500 hover:text-[#671E1F]"
                                    }`}
                            >
                                {type}
                            </button>
                                ...
                                <button
                                    ...
                                    className={`p-3 rounded-xl border transition-all text-center flex flex-col gap-0.5 ${
                                        disabled
                                            ...
                                            : isSelected
                                                ? "bg-[#671E1F] border-[#671E1F] text-white shadow-lg shadow-[#671E1F]/20"
                                                : "bg-white border-slate-100 hover:border-slate-200"
                                    }`}
                                >
            ...
            <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pt-3 pb-[max(1rem,env(safe-area-inset-bottom))] bg-white/95 backdrop-blur-md border-t border-slate-100 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
                <Button
                    ...
                    className={`w-full h-14 rounded-2xl font-bold text-lg transition-all ${selectedSlot
                        ? "bg-[#671E1F] hover:bg-[#218a56] text-white shadow-lg shadow-[#671E1F]/25"
