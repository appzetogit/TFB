  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] pb-24">
      ...
      <div className="px-4 sm:px-6 md:px-8 lg:px-10 py-6 md:py-8 lg:py-10 space-y-6 md:space-y-8">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            {/* Selection Checkmark */}
            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-8 h-8 bg-red-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
                  ...
                  return (
                    <button
                      ...
                      className={`relative px-3 py-3 rounded-xl text-sm font-semibold transition-all duration-200 ${
                        isSelected
                          ? 'bg-white dark:bg-[#2a2a2a] border-2 border-red-700 dark:border-red-500 text-red-700 dark:text-red-400'
                    ...
                    >
                      {option.label}
                      {option.popular && (
                        <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-red-700 dark:bg-red-600 text-white text-[10px] px-2 py-0.5 rounded font-semibold whitespace-nowrap">
                          POPULAR
                        </span>
                      )}
                    </button>
                ...
                <div className="pt-3">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-14 text-lg border-gray-200 dark:border-gray-700 focus:border-red-600 dark:focus:border-red-500 w-full focus:ring-red-600 dark:focus:ring-red-500 rounded-xl bg-white dark:bg-[#2a2a2a] text-gray-900 dark:text-white placeholder:text-gray-500 dark:placeholder:text-gray-400"
                      min="100"
                      max="50000"
                    />
                  </div>
          ...
          <Card className="border border-gray-100 dark:border-gray-800 shadow-sm bg-white dark:bg-[#1a1a1a]">
            <CardContent className="p-4">
              <Textarea
                ...
                className="min-h-[120px] border w-full border-gray-200 dark:border-gray-700 rounded-xl p-4 resize-none focus-visible:ring-1 focus-visible:ring-red-600 dark:focus-visible:ring-red-500 focus:border-red-600 dark:focus:border-red-500 text-gray-700 dark:text-white text-base bg-white dark:bg-[#2a2a2a] placeholder:text-gray-500 dark:placeholder:text-gray-400"
                maxLength={200}
              />
          ...
          <Card className="border border-gray-100 dark:border-gray-800 shadow-sm bg-gray-50/50 dark:bg-gray-900/30">
            <CardContent className="p-4 space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-red-600 dark:bg-red-500 mt-2 flex-shrink-0" />
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a1a] border-t border-gray-100 dark:border-gray-800 p-4 shadow-lg">
        <Button 
          className="w-full h-14 bg-red-700 dark:bg-red-600 hover:bg-red-800 dark:hover:bg-red-700 text-white font-semibold text-base rounded-xl transition-all duration-200"
          onClick={() => {
