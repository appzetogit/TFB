  ...
  useEffect(() => {
    if (itemCount > 0 && linkRef.current && !removedProduct && !flyingProduct && !lastRemoveEvent) {
      ...
      tl.to(linkRef.current, {
        scale: 1.08,
        boxShadow: '0 10px 25px rgba(103, 30, 31, 0.4)',
        duration: 0.15,
        ease: 'power2.out',
      ...
      .to(linkRef.current, {
        scale: 1.0,
        boxShadow: '0 4px 12px rgba(103, 30, 31, 0.3)',
        duration: 0.2,
        ease: 'power2.inOut',
      })
      ...
      {itemCount > 0 && !shouldHidePill && typeof document !== 'undefined' && createPortal(
          ...
          >
            ...
            <button
              ...
              className={`bg-[#671E1F] text-white rounded-full shadow-xl shadow-[#1b5f3e]/40 px-3 py-2 flex items-center gap-2 hover:bg-[#238654] transition-all duration-300 pointer-events-auto border border-[#1b5f3e]/40 backdrop-blur-sm cursor-pointer ${pillClassName}`}
            >
