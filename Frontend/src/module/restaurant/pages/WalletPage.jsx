    ...
    <div className="min-h-screen bg-[#f6e9dc] overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 pb-24 md:pb-6 overflow-x-visible">
        ...
        <motion.div
          ...
          className={isBalanceAdjusted ? "bg-red-50 border-2 border-red-200 rounded-xl p-4 md:p-6 mb-4 shadow-md" : "bg-[#ffebee] rounded-xl p-4 md:p-6 mb-4 shadow-md"}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className={isBalanceAdjusted ? "bg-red-200/50 rounded-lg p-3" : "bg-red-200/50 rounded-lg p-3"}>
                <DollarSign className={isBalanceAdjusted ? "w-6 h-6 md:w-8 md:h-8 text-red-700" : "w-6 h-6 md:w-8 md:h-8 text-red-700"} />
              </div>
              <div>
              ...
              <Card className="bg-white shadow-md border-0 py-0 gap-0 h-full w-full">
                <CardContent className="p-2 relative flex flex-col px-2 h-full justify-between">
                  <div className="absolute right-1 top-1 opacity-10">
                    <Hand className="w-6 h-6 md:w-8 md:h-8 text-red-500" />
                  </div>
