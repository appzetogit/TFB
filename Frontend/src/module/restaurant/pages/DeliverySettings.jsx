            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  >
                    <div className={`w-2 h-2 rounded-full ${deliveryStatus ? "bg-red-500 animate-pulse" : "bg-gray-600"}`}></div>
                ...
                <Switch
                  ...
                  className="ml-4 data-[state=checked]:bg-red-500 data-[state=unchecked]:bg-gray-300"
                />
              </div>
            </CardContent>
          </Card>
