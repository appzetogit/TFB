...
const restaurants = [
  {
    restaurantName: "Tifunbox Biryani Junction",
    ownerName: "Arjun Reddy",
    ownerEmail: "arjun.biryanijunction@tifunbox.test",
  ...
  {
    restaurantName: "Tifunbox Coastal Bowl",
    ownerName: "Neha Nair",
    ownerEmail: "neha.coastalbowl@tifunbox.test",
  ...
  {
    restaurantName: "Tifunbox Veggie Tandoor",
    ownerName: "Ritika Sharma",
    ownerEmail: "ritika.veggietandoor@tifunbox.test",
  ...
  {
    restaurantName: "Tifunbox Spice Route",
    ownerName: "Faizan Ali",
    ownerEmail: "faizan.spiceroute@tifunbox.test",
  ...
  {
    restaurantName: "Tifunbox Wings & Woks",
    ownerName: "Sonal Gupta",
    ownerEmail: "sonal.wingsandwoks@tifunbox.test",
